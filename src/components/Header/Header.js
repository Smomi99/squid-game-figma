          ...
          <Container fluid className='ms-4'>
            ...
            <Navbar.Collapse id="navbarScroll">
              <Nav
                ...
                navbarScroll
              >
                <Nav.Link className='navbar-item' href="#action1"> <img className='ms-2' style={{ height: '16px' }} src={austin} alt="" /><span className='text-white' style={{ fontSize: '10px' }}> 0x71C...8976F</span></Nav.Link>
